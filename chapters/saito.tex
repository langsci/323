...
\ex \label{saitoii}
\gll {Ano} {karee-wa} [$_{S}$ {okaasan-ga} {tuku-tta}]-\{{teki-da/ppoi}\}.\\
...
\glt `John$_{i}$ told Mary something like what she should eat at his$_{i}$ restaurant.’ \jambox*{(\citealt{Saito2017}: 167)}
\end{exe}
