...
\ex \label{Todoro9b}
\gll {Naa=\textbf{hl}} {lim=\textbf{it}} \uline{~~~}? \\
    who={\cn} sing={\sx} \\
...
\ex \label{Todoro10a}
\gll {Hilmoo-\textbf{yi}-'y=t} Mary. \\
    help-{\tr}-1.{\sg}.{\seriesII}={\pn} Mary \\
\glt `I helped Mary.'  
\ex \label{Todoro10b}
\gll {Naa=\textbf{hl}} {hlimoo-\textbf{yi-n}} \uline{~~~}?\\
...
\ex \label{Todoro11b}
\gll {Naa} {\textbf{an=t}} {gup(\uline{~~~})=hl} {susiit}? \\
...
\ex \label{Todoro14b}
\gll {\textbf{Dim}} {yookw-t} {James} ({ji} {taahlakxw}). \\
...
A note is in order regarding the future-oriented and tenseless complements. Given that \emph{dim} always occurs pre-predicatively in complements of ‘want’, M\&T argue that \emph{dim} is located in the embedded clause. This is different from future-oriented complements in languages like English, in which there is no overt futurity marker. M\&T take the overtness of \emph{dim} in these complements as an additional argument for the futurity stemming from the complements of verbs like ‘\emph{want}’, rather than the verb itself (in line with \citealt{abusch2004a}, \citealt{wurmbrand2014a}, \citealt{todoroviwurmbrand2020b}, pace \citealt{ogihara1996a}, \citealt{abusch1997a}, \citealt{pearson2017a}, i.a).	
	...
	Regarding ‘try’ in Gitksan, it is realized either as a pre-verbal element \emph{si’ix}, with which \emph{dim} never occurs, as in \REF{Todoro21}, or as a verb \emph{bak̲}, which obligatorily takes \emph{dim}. I return to this difference in Section 5. 
	
\begin{exe}
\ex \label{Todoro22} [\emph{We are watching the race and I spot injured Colin trying to run,
         limping along. I tell you:}] \\
\gll {Bag-a-t}	[\#(\textbf{{dim}}) 	{bax̱-t}].  \\
...
\ex \label{Todoro23b}
\tsc{[tp \textbf{pres} [aspp [vp [cp [tp \textbf{pres} [aspp prog [vp]]]]]]]}
...
\ex \label{Todoro24b}
\tsc{[tp \textbf{pres} [aspp [vp [cp [tp \textbf{past} [aspp [vp]]]]]]]}
...
\ex \label{Todoro25b}
\tsc{[tp \textbf{past} [aspp [vp [cp [tp \textbf{pres} [aspp [vp]]]]]]]}
...
\ex \label{Todoro26b}
\tsc{[tp \textbf{past} [aspp [vp [cp [tp \textbf{past} [aspp [vp]]]]]]]}
...
\ex \label{Todoro27b}
\tsc{[tp \textbf{pres} [aspp [vp [cp [tp \textbf{pres} [modp $\emptyset$ [aspp \textbf{\textit{dim}} [vp]]]]]]]]}
...
\ex \label{Todoro28b}
\tsc{[tp \textbf{pres} [aspp [vp [cp [tp \textbf{past} [modp $\emptyset$ [aspp \textbf{\textit{dim}} [vp]]]]]]]]}
...
\ex \label{Todoro29b}
\tsc{[tp \textbf{past} [aspp [vp [cp [tp \textbf{pres} [modp $\emptyset$ [aspp \textbf{\textit{dim}} [vp]]]]]]]]}
...
\ex \label{Todoro31b}
\tsc{[tp \textbf{past} [aspp [vp [cp [tp \sout{\textbf{past}} [modp \textbf{woll} [aspp [vp]]]]]]]]}
...
\ex \label{Todoro32b}
\tsc{[tp \textbf{past} [aspp [vp [cp [tp \textbf{\sout{past}} [modp $\emptyset$ [aspp \textbf{\emph{dim}} [vp]]]]]]]]}
...
\ex \label{Todoro33b}
\tsc{[tp \textbf{pres} [aspp [vp [tp \textbf{pres} [modp $\emptyset$ [aspp \textbf{\emph{dim}} [vp]]]]]]]}
...
\ex \label{Todoro34b}
\tsc{[tp \textbf{past} [aspp [vp [tp \textbf{pres} [modp $\emptyset$ [aspp \textbf{\emph{dim}} [vp]]]]]]]}
...
\ex \label{Todoro35b}
\tsc{[tp \textbf{past} [aspp [vp [tp \textbf{past} [modp $\emptyset$ [aspp \textbf{\emph{dim}} [vp]]]]]]]}
...
\ex \label{Todoro37b}
\tsc{[tp \textbf{pres} [aspp [vp [tp \textbf{past} [modp $\emptyset$ [aspp \emph{\textbf{dim}} [vp]]]]]]]}
...
\ex \label{Todoro38a} 
\tsc{[tp \textbf{pres} [aspp [vp want [modp $\emptyset$ [aspp \textbf{dim} [vp]]]]]]}

\ex \label{Todoro38b}
\tsc{[tp \textbf{past} [aspp [vp want [modp $\emptyset$ [aspp \textbf{dim} [vp]]]]]]}
...
\ex \label{Todoro39a}
\gll {Yukw[=hl]}	{si'ix} 	(\#{\textbf{dim}}) 	{bax̱-t}.	  \\
  \tsc{prog[=cn]}	try	(\#\tsc{prosp})	run-3.{\seriesII} \\
\glt `He’s trying to run.' 
...
\gll {‘Nim}	  (\#{\textbf{dim}})	{bax̱-t}          {Colin}.\\ 
...
\ex \label{Todoro49a}
\gll {Gilbil=hl} {g̱anuutxw=hl}  {dat} 	  { mahl-i=s}	{ Diana}  [(\#{\textbf{wil}}) {\textbf{dim}}   {\textbf{wil}}     {yee-t}   {g̱o’o=h}l { Winnipeg} {am} {k’i’y=hl}	{g̱anuutxw}]. \\
...
\ex \label{Todoro49b}
\gll {Sim} 	   {hasag̱-a’y}     [(\#{\textbf{wil}}) \textbf{{dim}} (\#\textbf{{wil}})	{alg̱al-i’y} 		{a=hl}		{Tenet}		{ky’oots}]. \\
...
\ex \label{Todoro49c}
\gll [{Yukw=hl}]	{si'ix} 	\textbf{(\#{wil})} 	{bax̱-t}.\\
		\tsc{prog}[=\tsc{cn}]	try	(\#\tsc{comp})	run-3.{\seriesII} \\
\glt ‘He’s trying to run.' 

\ex \label{Todoro49d}
\gll {Bag-a-t}	 [\textbf{(\#{wil})}  \textbf{{dim}}		\textbf{(\#{wil})} {bax̱-t}]. \\
...
\ex \label{Todoro51a}
\gll {Witxw}	{‘nit}	  \textbf{{dim}}	\textbf{{wil}}	{hahla’ls-t}. \\
    arrive	3\tsc{sg.ii}   \tsc{prosp}	\tsc{comp}	work-3.{\seriesII}\\
\glt `She arrived to work.' 

\ex \label{Todoro51b}
\gll {’Witxw}	{‘nit}	     \textbf{{wil}}	\textbf{{dim}} 	{hahla’ls-t}. \\
