...
cf. examples in \REF{pereex:key:1} above.
...
\ea[*]{%11
    ...
    \gll ɐd   asǝ   bel\\
    with   this   spade    \\
    \jambox{Iron Ossetic \il{Iron Ossetic} 
        \il{Ossetic} % TODO: verify that Ossetic is a hyperonym for Iron Ossetic
    }
...
For example, in the Russian examples in \REF{pereex:key:1} above, the DP quantified subject in \REF{pereex:key:1a} denotes a plural individual 
whereas the Small Nominal quantified subject in \REF{pereex:key:1b} has a non-referential, group interpretation. 
Likewise, in the Tatar examples in \REF{pereex:key:3}, the DP object in \REF{pereex:key:3a} has a definite interpretation (even in the absence of a demonstrative), 
whereas the Small Nominal object in \REF{pereex:key:3b} has an indefinite interpretation. 
...
\ea%13
    \label{pereex:key:13}
    Russian\footnote{The neuter form in \REF{pereex:key:13b} receives variable judgments from speakers but the majority of speakers reject it.} 
    \il{Russian}
    \ea{%13a
        \label{pereex:key:13a}
...
\ea%17
    ...
    \ex[]{
        ...
        \glt “Marat ate some porridge quickly.” \\ NOT: “Marat ate this porridge quickly.”
    }
    \z 
\z 
