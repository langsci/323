...
The structures are illustrated in \REF{shenex16} with English translation.\footnote{The shared verb is assumed to move to a higher node in \citet{Citko:2011}'s proposal. 
%Citko2006a,
...
\end{forest}
\z
\REF{shensvs} contrasts with the sentence in \REF{shenex25} where the head noun is plural. \citet{Shen:2018a} argues that the plural noun indicates a different structure, illustrated below: \textit{John's} and \textit{Mary's} are conjoined in the Spec,DP position. No sharing/multidominance is involved. 
