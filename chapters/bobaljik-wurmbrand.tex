...
\ea{\gll Ich glaub mein Lunch ist aus-ge-spill-ed. (CSw/Ger)\\
I believe my Lunch is out-\textsc{ptcp}-spill-\textsc{past}\\
\glt `I think my lunch spilled (out).' (2016.04.21)}
\ex{\gll \ldots und dann [es] runter-scrape-n, und es wird ein-ge-roll-t. (CSw/Ger)\\
...
\ex[\%]{\gll \label{turnonen}Wir turn-on-en das Ger\"at. (CSw-peers)\\
...
\ex{\gll \label{fangt-an}Der 2. Staffel f\"angt \textit{t}$_{\text{PP}}$ an [ mit einer wichtigen Szene ]. (Ger)\\
...
\ea
\ea{\gll \label{kaufen-koennen}Sie wird das Buch kauf-en k\"onn-en. (Ger)\\
she will the book buy-\textsc{inf} can-\textsc{inf}\\
\glt `She will be able to buy the book.'}
\ex{\gll \ldots bevor sie es kauf-en k\"onn-en. (Ger)\\
...
\ea 
\ea{\gll \label{kaufen-koennen-b}Sie wird es kauf-en k\"onn-en. (Ger)\\
...
\ea\label{clusters}
\ea{\gll \label{3-2-1}\ldots weil er es kaufen$_{3}$ k\"onnen$_{2}$ wird$_{1}$. (Ger)\\
\ldots since he it buy can will\\}
\ex{\gll \ldots weil er es kaufen$_{3}$ wird$_{1}$ k\"onnen$_{2}$ . (Ger)\\
\ldots since he it buy will can\\}
\ex{\gll \ldots weil er es wird$_{1}$ kaufen$_{3}$ k\"onnen$_{2}$ . (Ger)\\
...
\ea{\gll \label{ipp}Der Kommissar hat den Fall nicht l\"os-en k\"onn-en. (Ger)\\
