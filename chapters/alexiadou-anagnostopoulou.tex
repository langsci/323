...
\abstract{In this paper we examine a particular type of causative construction in Greek, 
    built on the basis of the verb matheno ‘learn’ and aspectual verbs like arhizo ‘start’. 
...
\footnote{
    ...
    The same reviewer asks if the anticausative of \REF{alexiadouex:key:11} is possible in Greek, which it is.
}
...
We would like to speculate that the ‘on’ seen in \REF{alexiadouex:key:20b} is a trace of the conative construction. 
